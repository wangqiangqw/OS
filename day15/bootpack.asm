...
_HariMain:
	...
	PUSH	0
	PUSH	DWORD [-1136+EBP]
	MOV	DWORD [-1120+EBP],8
	MOV	DWORD [-1124+EBP],7
	CALL	_sheet_slide
	ADD	ESP,36
	MOVSX	EAX,WORD [4084]
...
L40:
	...
	CMP	EBX,339
	SETLE	BYTE [-1172+EBP]
	MOV	DL,BYTE [-1172+EBP]
	TEST	CL,CL
	SETNE	AL
	AND	EAX,EDX
	AND	EAX,1
	JE	L8
	CMP	DWORD [-1120+EBP],143
	JG	L8
	PUSH	1
	MOV	BYTE [-92+EBP],CL
	PUSH	ESI
